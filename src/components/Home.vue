    ...
    data() {
      return {
        ...
        section: [{
            ...
            text: "is an establishing multidisciplinary organization with extensive expertise in Environmental - Management of all related project phases. It is wholly owned and managed by previously disadvantaged individuals (females). The company is 100% owned by women, who pride themselves in upholding black empowerment by willing to employ previously disadvantaged individuals, ensuring skills transfer to all communities served."
          },
          {
            title: "Background",
            text: "The company has been established in 2007 and started operation in 2008, with a view of the need to provide environmental related services. The company is rooted in Limpopo. Mulinda Environmental Consulting’s core values of integrity, knowledge and service, an essential combination needed to deliver to our clients and the communities served."
          },
          {
            show: true,
            text: "The shareholders are experienced persons in consulting with special skills in environmental management, sanitation and water resources with 9 years or more experience in the field of managing various projects of environmental, sanitation, water resources, and civil engineering related issues."
          },
          {
        ...
        projects: [{
          ...
          {
            title: "Upgrading of Vanderbjil Park , Tshepiso, Rustervaal and Nanescol Cemeteries",
          ...
          {
            title: "construction of 300 Ventilated Improved Pitlatrines sanitation project",
          ...
          {
            title: "and M Construction of 200 Ventilated Improved Pitlatrines sanitatiproject pality",
            client: "Mopani District Municipality",
            ref: {
              name: "Technical director:Mr Ramathoka",
          ...
          {
            title: "Upgrading of Lenyenye sewage works in partner with KACE consulting Engineers.",
            client: "Mopani District Municipality",
            ref: {
              name: "Mr Grobler",
              contact: "0823235755"
          ...
          {
            title: "Cco u Construction of Mzilela and Khaxani water reticulatio line in partn with MOT Proffessional Consultancy",
            client: "Mopani District Municipality",
            ref: {
              name: "Mr Lesufi",
              contact: "0826637328"
          ...
          {
            title: "Upgrading of Tanda and Tshikhudini water reticulation line in partner with Tshino",
          ...
          {
            title: "EIA fo Construction of Alldays and Lebowakgomu A &B taxi \nrank a\nnd mulmulti purpose centre in partner with Tshino",
          ...
          {
            title: "Tonwship establishment Ga-Ntata village in Partner with with Makasane deveiopers",
            client: "Mopani District Municipality",
            ref: {
          ...
          {
            title: "Mini P mining perrmi t for Rediramokgo Trading cc in Maruleng Marule Municipality",
          ...
          {
            title: "filling Filling station establishment, done for Devrede Krom\n hoek kroem Filling Station cc",
          ...
          {
            title: "Upgra Arconhoek Buffelshoek and Okkernootboom Bulk water water Supply, Mpumalanga Province for MOT in partnership with",
          ...
          {
            title: "Tours Bulk Water Scheme (Refurbishment of Boreholes and Bulk Line Linking Main Reservoir to supply Reservoirs) within Greater Tzaneen Local Municipality in partnership with Tangos",
          ...
          {
            title: "Road Maintenance from Mica to the Oaks within Maruleng Local Municipality in partner with KWCRS",
            client: "Road Agency",
            ref: {
              name: "Mr Baloyi",
              contact: "0152914934"
          ...
          {
            title: "The upgrading Mohlamme access road from gravel to tar in Ntwane Settlement within Elias Motsoaledi Local Municipality in partner with MOT",
          ...
          {
            title: "Project Management and Operational support consultant to the upgrading of road T571D from MarbleHall to Modimolle in the Waterberg District Municipality, Limpopo \nProvince",
          ...
          {
            title: "Project Management and Operational support consultant to the upgrading and Extension of Giyani Water Treatment Works/Plant within Giyani Local Municipality with Mopani District Municipality in partnership with Tangos, Limpopo Province",
            client: "Mopani District",
            ref: {
              name: "Mr F Ngobe",
              contact: "0829405454"
            },
            activity: "EIA’s, EMPr for borrow pits mining permits & Environmental Monitoring Compliance",
            status: "100%"
          },
          {
            title: "EIAs and Application of borrow pits mining permits for the upgrading of Modlijadji to Mavele road , Mopani District Municipality in partnership with KACE consulting Engineers, Limpopo Province",
            client: "Mopani District Municipality",
            ref: {
              name: "Mr Grobler",
              contact: "0823235755"
          ...
          {
            title: "EIAs and Application of borrow pits mining permits for the upgrading of Marongwane to Thusang Road , Bushbuck ridge Local Municipality in partnership with GSTCE Consulting Engineers , Mpumalanga Province",
            client: "Bushbuckridge Local Municipality",
            ref: {
              name: "Boniface",
              contact: "0843712359"
          ...
          {
            title: "EIAs and Application of borrow pits mining permits for the upgrading of Kgaphamadi Route and storm water discharge , Sekhukhune District Municipality with Sky High Consulting Engineers in partnership with",
...
<style scoped>
  ...
  .topNav {
    padding-top: 5%;
    background-image: url("/static/img/forestBj.jpg");
    min-height: 0%;
    height: 100%;
